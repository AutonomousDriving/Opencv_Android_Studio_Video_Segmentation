...
#include <jni.h>
/* Header for class com_example_dedoo_segmen_DetectionBasedTracker */

#ifndef _Included_com_example_dedoo_segmen_DetectionBasedTracker
#define _Included_com_example_dedoo_segmen_DetectionBasedTracker
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_example_dedoo_segmen_DetectionBasedTracker
